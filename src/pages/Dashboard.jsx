...
export default function Dashboard({ employees }) {
  ...
  // Mock data for the weekly chart to make it look active
  const weeklyData = [
    { day: 'Mon', percent: 95 },
    { day: 'Tue', percent: 88 },
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700 pb-10 flex flex-col min-h-full">
      ...
      {/* --- NEW BOTTOM SECTION: ANALYTICS & TELEMETRY --- */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 flex-1">
        
        {/* Attendance Analytics Chart (Left Side) */}
        ...
        {/* Right Side: Stacked Video & Telemetry */}
        <div className="flex flex-col gap-6">
          ...
          {/* System Telemetry / Activity Stream */}
          <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 flex-1 flex flex-col">
            ...
            <div className="flex-1 flex flex-col gap-5 relative">
              ...
              <div className="flex gap-4 relative z-10">
                <div className="w-5 h-5 rounded-full bg-emerald-100 border-4 border-white flex-shrink-0 flex items-center justify-center">
                  <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full"></div>
                </div>
                <div>
                  <p className="text-xs font-bold text-slate-900 leading-none">Database Synced</p>
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1">Just now</p>
                </div>
              </div>

              {/* Event 2 */}
              <div className="flex gap-4 relative z-10">
                <div className="w-5 h-5 rounded-full bg-indigo-100 border-4 border-white flex-shrink-0 flex items-center justify-center">
                  <div className="w-1.5 h-1.5 bg-indigo-500 rounded-full"></div>
                </div>
                <div>
                  <p className="text-xs font-bold text-slate-900 leading-none">Admin Session Verified</p>
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1">12 mins ago</p>
                </div>
              </div>

              {/* Event 3 */}
              <div className="flex gap-4 relative z-10">
                <div className="w-5 h-5 rounded-full bg-slate-100 border-4 border-white flex-shrink-0 flex items-center justify-center">
                  <div className="w-1.5 h-1.5 bg-slate-400 rounded-full"></div>
                </div>
                <div>
                  <p className="text-xs font-bold text-slate-900 leading-none">Cloud Backup Completed</p>
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1">03:00 AM</p>
                </div>
              </div>
            </div>
          </div>
