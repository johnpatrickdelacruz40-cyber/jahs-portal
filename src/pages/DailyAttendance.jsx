                            ...
                            <div className={printMode === 'dtr' ? 'p-0' : 'p-8 md:p-12'}>
                              ...
                              <div className={`mb-6 flex justify-between items-center bg-white p-6 rounded-2xl border border-slate-200 shadow-sm ${printMode === 'dtr' ? 'hidden' : 'flex'}`}>
                                <div className="flex items-center gap-3">
                                  ...
                                  <div><p className="font-bold text-slate-900 text-sm">Interactive DTR Editor</p><p className="text-[10px] text-slate-400 uppercase tracking-widest font-black mt-0.5">Type directly into the paper to record overtime before printing</p></div>
                                </div>
                              ...
                              <div className={`bg-white max-w-3xl mx-auto ${printMode === 'dtr' ? 'p-0' : 'shadow-2xl border border-slate-200 p-10 md:p-14'} min-h-[1000px]`}>
                                ...
                                <div className="mb-6 text-sm flex items-end">
                                  ...
                                  <input type="text" defaultValue={emp.name} className="font-bold border-b border-black ml-3 flex-1 px-2 py-0.5 outline-none bg-transparent hover:bg-indigo-50 focus:bg-indigo-100 transition-colors" />
                                </div>
